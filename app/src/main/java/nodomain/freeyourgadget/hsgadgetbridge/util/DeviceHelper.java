...
package nodomain.freeyourgadget.hsgadgetbridge.util;
...
import nodomain.freeyourgadget.hsgadgetbridge.devices.UnknownDeviceCoordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.hplus.EXRIZUK8Coordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.hplus.HPlusCoordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.hplus.MakibesF68Coordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.huami.amazfitbip.AmazfitBipCoordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.huami.amazfitcor.AmazfitCorCoordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.huami.miband2.MiBand2Coordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.huami.miband2.MiBand2HRXCoordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.jyou.TeclastH30Coordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.liveview.LiveviewCoordinator;
...
import nodomain.freeyourgadget.hsgadgetbridge.devices.no1f1.No1F1Coordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.pebble.PebbleCoordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.vibratissimo.VibratissimoCoordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.xwatch.XWatchCoordinator;
import nodomain.freeyourgadget.hsgadgetbridge.entities.Device;
import nodomain.freeyourgadget.hsgadgetbridge.entities.DeviceAttributes;
