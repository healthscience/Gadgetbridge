...
package nodomain.freeyourgadget.hsgadgetbridge.service.devices.miband2;
...
import nodomain.freeyourgadget.hsgadgetbridge.activities.SettingsActivity;
...
import nodomain.freeyourgadget.hsgadgetbridge.deviceevents.GBDeviceEventBatteryInfo;
import nodomain.freeyourgadget.hsgadgetbridge.deviceevents.GBDeviceEventCallControl;
import nodomain.freeyourgadget.hsgadgetbridge.deviceevents.GBDeviceEventFindPhone;
import nodomain.freeyourgadget.hsgadgetbridge.deviceevents.GBDeviceEventVersionInfo;
import nodomain.freeyourgadget.hsgadgetbridge.devices.SampleProvider;
import nodomain.freeyourgadget.hsgadgetbridge.devices.huami.ActivateDisplayOnLift;
import nodomain.freeyourgadget.hsgadgetbridge.devices.huami.HuamiCoordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.huami.HuamiFWHelper;
import nodomain.freeyourgadget.hsgadgetbridge.devices.huami.amazfitbip.AmazfitBipService;
import nodomain.freeyourgadget.hsgadgetbridge.devices.huami.miband2.MiBand2FWHelper;
import nodomain.freeyourgadget.hsgadgetbridge.devices.miband.DateTimeDisplay;
import nodomain.freeyourgadget.hsgadgetbridge.devices.miband.DoNotDisturb;
import nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBand2SampleProvider;
import nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBand2Service;
import nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst;
import nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandCoordinator;
import nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandService;
import nodomain.freeyourgadget.hsgadgetbridge.devices.miband.VibrationProfile;
import nodomain.freeyourgadget.hsgadgetbridge.devices.miband2.MiBand2Const;
...
import nodomain.freeyourgadget.hsgadgetbridge.entities.MiBandActivitySample;
import nodomain.freeyourgadget.hsgadgetbridge.entities.User;
import nodomain.freeyourgadget.hsgadgetbridge.impl.GBAlarm;
import nodomain.freeyourgadget.hsgadgetbridge.impl.GBDevice.State;
import nodomain.freeyourgadget.hsgadgetbridge.model.ActivitySample;
import nodomain.freeyourgadget.hsgadgetbridge.model.ActivityUser;
...
import nodomain.freeyourgadget.hsgadgetbridge.model.CalendarEvents;
...
import nodomain.freeyourgadget.hsgadgetbridge.model.DeviceService;
...
import nodomain.freeyourgadget.hsgadgetbridge.service.btle.AbstractBTLEDeviceSupport;
import nodomain.freeyourgadget.hsgadgetbridge.service.btle.BLETypeConversions;
import nodomain.freeyourgadget.hsgadgetbridge.service.btle.BtLEAction;
import nodomain.freeyourgadget.hsgadgetbridge.service.btle.GattCharacteristic;
import nodomain.freeyourgadget.hsgadgetbridge.service.btle.GattService;
import nodomain.freeyourgadget.hsgadgetbridge.service.btle.TransactionBuilder;
import nodomain.freeyourgadget.hsgadgetbridge.service.btle.actions.AbortTransactionAction;
import nodomain.freeyourgadget.hsgadgetbridge.service.btle.actions.SetDeviceStateAction;
import nodomain.freeyourgadget.hsgadgetbridge.service.btle.profiles.alertnotification.AlertCategory;
import nodomain.freeyourgadget.hsgadgetbridge.service.btle.profiles.deviceinfo.DeviceInfoProfile;
import nodomain.freeyourgadget.hsgadgetbridge.service.btle.profiles.heartrate.HeartRateProfile;
import nodomain.freeyourgadget.hsgadgetbridge.service.devices.common.SimpleNotification;
import nodomain.freeyourgadget.hsgadgetbridge.service.devices.huami.HuamiDeviceEvent;
import nodomain.freeyourgadget.hsgadgetbridge.service.devices.miband.NotificationStrategy;
import nodomain.freeyourgadget.hsgadgetbridge.service.devices.miband.RealtimeSamplesSupport;
import nodomain.freeyourgadget.hsgadgetbridge.service.devices.miband2.actions.StopNotificationAction;
import nodomain.freeyourgadget.hsgadgetbridge.service.devices.miband2.operations.FetchActivityOperation;
import nodomain.freeyourgadget.hsgadgetbridge.service.devices.miband2.operations.FetchSportsSummaryOperation;
import nodomain.freeyourgadget.hsgadgetbridge.service.devices.miband2.operations.InitOperation;
import nodomain.freeyourgadget.hsgadgetbridge.service.devices.miband2.operations.UpdateFirmwareOperation;
import nodomain.freeyourgadget.hsgadgetbridge.util.GB;
import nodomain.freeyourgadget.hsgadgetbridge.util.NotificationUtils;
import nodomain.freeyourgadget.hsgadgetbridge.util.Prefs;
import nodomain.freeyourgadget.hsgadgetbridge.util.Version;

import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COLOUR;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COUNT;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_DURATION;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_ORIGINAL_COLOUR;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_COUNT;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_DURATION;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PAUSE;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PROFILE;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.FLASH_COLOUR;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.FLASH_COUNT;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.FLASH_DURATION;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.FLASH_ORIGINAL_COLOUR;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.VIBRATION_COUNT;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.VIBRATION_DURATION;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.VIBRATION_PAUSE;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.VIBRATION_PROFILE;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.getNotificationPrefIntValue;
import static nodomain.freeyourgadget.hsgadgetbridge.devices.miband.MiBandConst.getNotificationPrefStringValue;
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (s.equals(DeviceInfoProfile.ACTION_DEVICE_INFO)) {
                handleDeviceInfo((nodomain.freeyourgadget.hsgadgetbridge.service.btle.profiles.deviceinfo.DeviceInfo) intent.getParcelableExtra(DeviceInfoProfile.EXTRA_DEVICE_INFO));
            }
        }
    };
...
//        }
    ...
    private void handleDeviceInfo(nodomain.freeyourgadget.hsgadgetbridge.service.btle.profiles.deviceinfo.DeviceInfo info) {
